...
// POST /prescriptions
// body: { patientName, diagnosis, chiefComplaints, allergies, medicalHistory,
//         vitals: {bp,pulse,spo2,temp,rr,weight},
//         medicines: [{name, morning, afternoon, evening, night, unit, duration, instructions}],
//         notes, followUp }

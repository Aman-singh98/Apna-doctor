...
// body: { doctorId, type: 'Video'|'Audio'|'Chat', familyMemberId?, date }
// Returns: { orderId, amount (paise), currency, keyId } — amount/keyId come
// from the backend, never computed or trusted client-side.
export async function createPaymentOrder(payload) {
   const { data } = await api.post('/patient/appointments/create-order', payload);
   return data;
}

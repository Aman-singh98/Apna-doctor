...
// Refunding needs a reason (the backend controller stores it on the Razorpay
// refund's notes — see services/refundService.js), so this is a dedicated
// modal rather than the generic ConfirmModal used for simple toggles.
const RefundPaymentModal = ({ patientName, amount, loading, onClose, onConfirm }) => {
		...
		>
			...
			>
				...
				<p style={{ fontSize: 13, color: 'var(--text-muted)', marginBottom: 12 }}>
					This issues a real refund on Razorpay for this transaction and cannot be undone. Please give a reason for the record.
				</p>
				...
				<div style={{ display: 'flex', justifyContent: 'flex-end', gap: 10 }}>
					...
					<button
						...
						style={{
							...
							background: 'var(--purple-accent)', color: '#fff', fontSize: 13, fontWeight: 600,
